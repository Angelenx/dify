...
def _installed_app_response_data(
    ...
    *,
    ...
    return InstalledAppResponse(
        ...
        created_by=installed_app.created_by,
...
class InstalledAppsListApi(Resource):
    ...
    def get(self, current_tenant_id: str, current_user: Account):
        ...
        installed_apps, has_more, next_cursor = InstalledAppService.get_visible_page(
            ...
            created_by=(
                ...
                else str(current_user.id)  # add_angelen
            ),
            cursor=cursor,
            limit=query.limit,
            app_id=query.app_id,
    ...
    def post(self, req_data: InstalledAppCreatePayload, current_tenant_id: str, current_user: Account):
        ...
        if installed_app is None:
            ...
            new_installed_app = InstalledApp(
                ...
                created_by=current_user.id,  # add_angelen
                is_pinned=False,
